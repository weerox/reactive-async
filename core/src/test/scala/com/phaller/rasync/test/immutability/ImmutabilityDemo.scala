...
class SSRootICM(final val o: SRootM)
    extends SRootI // O: Conditionally Immutable // T: Conditionally Immutable

class SRootI_EF
    extends Root(1) { // [If we have an analysis for effectively final fields…] // O: Immutable // T: Immutable
